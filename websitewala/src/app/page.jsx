        ...
        <div className={styles.container}>
          <div className={styles.textContainer}>
            ...
            <p className={styles.desc}>
              Our team of expert designers and developers specializes in creating stunning, responsive websites tailored to your unique requirements. Whether you&apos;re a small business, a startup, or an established enterprise, we have the expertise to elevate your online presence and drive results.
            </p>
